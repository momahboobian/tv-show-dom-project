const companiesLogo = [
  "/assets/img/companies/logo-kodi.png",
  "/assets/img/companies/logo-plex.png",
  "/assets/img/companies/logo-netflix.png",
  "/assets/img/companies",
  "/assets/img/companies/logo-infuse.png",
  "/assets/img/companies/logo-jellyfin.png",
  "/assets/img/companies/logo-emby.png",
  "/assets/img/companies/logo-mediaportal.png",
  "/assets/img/companies",
  "/assets/img/companies/logo-mrmac.png",
  "/assets/img/companies/logo-stremio.png",
  "/assets/img/companies/logo-vlc.png",
];
